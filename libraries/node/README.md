...
This module provides Express middleware for validating JWTs ([JSON Web Tokens](https://jwt.io)). The decoded JWT payload is available on the request object.

## Install

```
$ npm install authg-jwt
```
...
```javascript
var { authgJwt: jwt } = require("authg-jwt");
// or ES6
// import { authgJwt } from "authgJwt-jwt";
