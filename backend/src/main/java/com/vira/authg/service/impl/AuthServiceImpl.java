...
public class AuthServiceImpl implements AuthService {
    ...
    @Override
    public String generateAppToken(ApplicationAuthorizationDto data) {
        ...
        return tokenProvider.createApplicationToken(app.getId(), app.getName(), app.getIdentifier(), app.getDomain());
    }
